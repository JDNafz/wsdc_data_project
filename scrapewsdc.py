            ...
            for event_level in westie:
                ...
                for i in range(len(eventList)):
                    ...
                    if eventList[i]['role'] == 'leader':
                        L_points += eventList[i]['points']
                    else:
                        F_points += eventList[i]['points']
                    ...
                    # Run tests here and perform actions here on individual dancers

                # print(str(L_points) +' '+ str(event_level)+ ' Lead points')    
                print(str(F_points) +' '+ str(event_level)+ ' Follower points')
